...
--
-- Host: localhost
-- Generation Time: Feb 28, 2024 at 09:56 PM
...
--
ALTER TABLE `ADMINORG`
  ADD CONSTRAINT `ADMINORG_ibfk_2` FOREIGN KEY (`OrgID`) REFERENCES `ORGANIZATION` (`OrgID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `FORM`
  ADD CONSTRAINT `OrgID` FOREIGN KEY (`OrgID`) REFERENCES `ORGANIZATION` (`OrgID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `USERORG`
  ...
  ADD CONSTRAINT `USERORG_ibfk_3` FOREIGN KEY (`Email`) REFERENCES `USER` (`Email`);
